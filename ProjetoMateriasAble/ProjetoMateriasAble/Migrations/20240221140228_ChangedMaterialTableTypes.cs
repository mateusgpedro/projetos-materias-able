        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    QuantitiesData = table.Column<Dictionary<int, int>>(type: "jsonb", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ManufacturerCodeRelations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ManufacturerCodeRelations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ManufacturerCodeRelations_Manufacturers_ManufacturerId",
                        column: x => x.ManufacturerId,
                        principalTable: "Manufacturers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ManufacturerCodeRelations_Materials_MaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ManufacturerCodeRelations_ManufacturerId",
                table: "ManufacturerCodeRelations",
                column: "ManufacturerId");

            migrationBuilder.CreateIndex(
                name: "IX_ManufacturerCodeRelations_MaterialId",
                table: "ManufacturerCodeRelations",
                column: "MaterialId");
