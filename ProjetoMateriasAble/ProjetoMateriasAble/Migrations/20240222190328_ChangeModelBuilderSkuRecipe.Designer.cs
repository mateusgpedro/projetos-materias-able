...
namespace ProjetoMateriasAble.Migrations
{
    ...
    [Migration("20240222190328_ChangeModelBuilderSkuRecipe")]
    partial class ChangeModelBuilderSkuRecipe
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjetoMateriasAble.Models.Platform.Recipe", b =>
                {
                    b.HasOne("ProjetoMateriasAble.Models.Platform.Sku", "Sku")
                        .WithOne("Recipe")
                        .HasForeignKey("ProjetoMateriasAble.Models.Platform.Recipe", "SkuId")
